...
class _createaccpageState extends State<createaccpage> {
  ...
  //to let flutter read what we write
  ...
  // ── Register function ──
  //to register the infos in data base
  Future<void> _register() async {
    ...
    try {
      final result = await ApiService.clientRegister(
      ...
      if (result['msg'] == 'Client registered') {
        // ✅ Success
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("CREATE YOUR ACCOUNT",
          style: TextStyle(color: Color(0xFFEAFBFF), fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 2),
        ),
